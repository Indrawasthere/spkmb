  ...
  const pengaduanData = [
    {
      ...
      isi: 'Saya warga Desa Sukamaju ingin melaporkan bahwa kualitas perkerasan jalan lingkar utara yang baru dibangun tidak rata. Terdapat gelombang dan permukaan tidak halus di beberapa titik terutama di Km 5+200 hingga Km 5+800.',
      status: 'DIPROSES' as const,
      pelapor: 'Bapak Joko Widodo',
      email: 'joko@example.com',
      telepon: '081234567890',
      kategori: 'PENGADAAN',
      nomor_tiket: 'TKT-20241015001',
      tanggal: new Date('2024-09-15'),
    },
    {
      judul: 'Progress Rehabilitasi Jembatan Lambat',
      isi: 'Saya mewakili masyarakat Desa Sukamaju ingin menyampaikan bahwa progress rehabilitasi jembatan Sungai Besar terkesan lambat. Sudah 4 bulan berjalan namun jembatan masih belum bisa dilewati.',
      status: 'BARU' as const,
      pelapor: 'Kepala Desa Sukamaju',
      email: 'kepaladesa@sukamaju.desa.id',
      telepon: '081298765432',
      kategori: 'PELAYANAN',
      nomor_tiket: 'TKT-20241015002',
